...
acil = ramuan.LINE() 
acil.login(token="EqcRnnFxk2jdpimxcc8a.UML/F5OMmCzegj+kXFSa6G.pMG1LJUWQ+yd3UJXvuPynOB4rxM2RUY4HEaUrmh+rIU=")
acil.loginResult()

pb1 = ramuan.LINE() 
pb1.login(token="EqJssL38g0yo4JoG00M9.5RaliWBlzSi7P4maDE0AYq.r9Fdr5Qfx8XGtwGgv7WP83BJML3wTzOjQVVmMM6Am30=")
pb1.loginResult()

pb2 = ramuan.LINE() 
pb2.login(token="Eqm6sYXZ10tdHm8Jstt7.w7PintyRt9WjtuWkjx6InW.yByydHZJOzLiUB+v6NdAq/rOJs0omsIIm8ln34j4njM=")
pb2.loginResult()
